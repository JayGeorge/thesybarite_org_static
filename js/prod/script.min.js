...
*/
Array.from(document.querySelectorAll(".js__megaMenuInitiate")).forEach((e=>{e.addEventListener("click",(function(t){e.closest("nav").classList.remove("js--megaMenuActive"),Array.from(document.querySelectorAll(".c-mega-menu-container")||[]).forEach((e=>{e.classList.remove("js--megaMenuActive")})),Array.from(document.querySelectorAll(".js--megaMenuActiveCurrentMenu")||[]).forEach((e=>{e.classList.remove("js--megaMenuActiveCurrentMenu")})),t.preventDefault(),e.nextElementSibling.classList.toggle("js--megaMenuActive"),e.classList.toggle("js--megaMenuActiveCurrentMenu"),setTimeout((function(){e.closest("nav").classList.add("js--megaMenuActive")}),50)}))}));