...
*/
Array.from(document.querySelectorAll(".js__megaMenuInitiate")).forEach((e=>{e.addEventListener("click",(function(t){Array.from(document.querySelectorAll(".c-mega-menu-container")||[]).forEach((e=>{e.classList.remove("js--megaMenuActive")})),Array.from(document.querySelectorAll(".js--megaMenuActiveCurrentMenu")||[]).forEach((e=>{e.classList.remove("js--megaMenuActiveCurrentMenu")})),t.preventDefault(),e.nextElementSibling.classList.toggle("js--megaMenuActive"),e.closest("nav").classList.toggle("js--megaMenuActive"),e.classList.toggle("js--megaMenuActiveCurrentMenu")}))}));